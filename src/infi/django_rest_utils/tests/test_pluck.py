...
class PluckTest(TestCase):
    ...
    def test_traversal(self):
        ...
        self.assertEquals(list(traverse('z', {'a': 1})), [])
        ...
        self.assertEquals(list(traverse('y/*', {'b': [3, 4]})), [])
        self.assertEquals(list(traverse('y/a', {'y': [3, 4]})), [])
        self.assertEquals(list(traverse('a/0/', {'a': [1]})), [('a/0', 1)])
    ...
    def test_pluck_results(self):
        self.assertEquals({'j':70, 'k': 90}, pluck_result({'t': 17, 'k': 90, 'j': 70}, ['j,k']))
